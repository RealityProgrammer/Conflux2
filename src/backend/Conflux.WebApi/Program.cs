...
builder.Services.AddScoped<IBlobUrlProvider>(services => services.GetRequiredService<StorageService>());
builder.Services.AddScoped<IBlobStorage>(services => services.GetRequiredService<StorageService>());
