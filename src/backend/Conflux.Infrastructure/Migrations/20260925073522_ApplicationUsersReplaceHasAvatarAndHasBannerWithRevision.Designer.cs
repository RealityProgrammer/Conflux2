...
namespace Conflux.Infrastructure.Migrations
{
    ...
    [Migration("20260925073522_ApplicationUsersReplaceHasAvatarAndHasBannerWithRevision")]
    partial class ApplicationUsersReplaceHasAvatarAndHasBannerWithRevision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("ManualPresenceStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.CommunityServerMember", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("BanExpireAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.CommunityServerRole", b =>
                {
                    ...
                    b.Property<byte>("SpecialRoleType")
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LatestMessageAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.Invitation", b =>
                {
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.Message", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Attachments"), "gin");
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.ServerModerationLog", b =>
                {
                    ...
                    b.Property<Guid?>("AffectedMemberId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ExecutorMemberId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.CommunityServer", b =>
                {
                    b.HasOne("Conflux.Domain.Entities.ApplicationUser", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Conflux.Domain.Entities.ApplicationUser", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.CommunityServerMemberRole", b =>
                {
                    b.HasOne("Conflux.Domain.Entities.CommunityServerMember", "Member")
                        .WithMany("MemberRoles")
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Conflux.Domain.Entities.CommunityServerRole", "Role")
                        .WithMany("MemberRoles")
            ...
            modelBuilder.Entity("Conflux.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Conflux.Domain.Entities.Message", "ReplyTo")
                        .WithMany("Replies")
