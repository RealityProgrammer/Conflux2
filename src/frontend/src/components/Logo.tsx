export default function Logo({...props}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="75 75 350 350" {...props}>
      ...
      <text x="250" y="390" fontFamily="system-ui, -apple-system, sans-serif" fontSize="44" fontWeight="800"
            fill="#F8FAFC" textAnchor="middle" letterSpacing="6" className="select-none">CONFLUX
      </text>
    </svg>
  );
}