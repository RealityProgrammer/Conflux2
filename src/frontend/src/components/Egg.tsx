...
export default function Egg() {
    ...
    return (
        <div className="min-h-0 flex-1 w-full mx-auto overflow-hidden flex items-center justify-center bg-black @container-size select-none">
            <div
            ...
            >
                <audio src="https://soundcloud.com/deltarune-unused-ost/man-ogg?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing"/>
