                    ...
                    <div className="w-full flex flex-col">
                      <div className="flex flex-row gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p
                            className="text-base text-white">{authorization.userProfile?.displayName ?? "Unknown sender"}</p>
                          ...
                          {attachmentCount > 0 && (
                            <p className="text-sm mt-1"><BsPaperclip
                              className="fill-white size-4 inline"/> With {attachmentCount} attachment{attachmentCount > 1 ? 's' : ''}.
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      {isError && (
                        <footer className="flex flex-col mt-4">
                          <p><BsExclamationTriangle
                            className="size-5 fill-white inline"/> {(message.operation as ErrorMessageOperation).errorMessage}
                          </p>

                          <div className="flex flex-row gap-2 justify-center items-center mt-4 mx-3">
                            <button className="button-theme-danger h-10 flex-1 cursor-pointer rounded-md"
                                    onClick={() => handleCancelSendErrorMessage(message.operationId)}>
                              Cancel Message
                            </button>

                            <button className="button-theme-primary h-10 flex-1 cursor-pointer rounded-md"
                                    onClick={() => handleRetryOperation(message.operationId)}>
                              Retry Message
                            </button>
                          </div>
                        </footer>
